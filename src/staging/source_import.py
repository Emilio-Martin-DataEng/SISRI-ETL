...
def process_source(source_name: str, force_ddl: bool = False, audit_id: int = None):
    ...
    format_subfolder = get_config("system", "format_subfolder", "format")

    format_dir = config_folder / format_subfolder / "sources"
    ...
    raw_root = get_config("data", "base_path", "C:/SISRI")
    ...
    for file_path in files:
        ...
        try:
            ...
            # Deduplicate PK - safe version with column mapping
            # Deduplicate PK - safe with auto-rename for spaces
            if pk_cols:
                rename_map = {}
