...
BEGIN
    EXEC sp_rename 'DW.Dim_Principals', 'Dim_Principals_backup_20260302_135601';
    -- Create new table
    ...
    INSERT INTO [DW].[Dim_Principals] SELECT * FROM [DW].[Dim_Principals_backup_20260302_135601];
END
ELSE
BEGIN
    CREATE TABLE [DW].[Dim_Principals] (
