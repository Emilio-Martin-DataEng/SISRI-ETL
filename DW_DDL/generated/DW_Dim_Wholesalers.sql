-- Safe regeneration template for DW.Dim_Wholesalers (SCD Type 1)
-- Generated at 2026-03-05 15:02:49

-- Drop old backup if it exists (prevents rename conflict)
IF OBJECT_ID('DW.Dim_Wholesalers_backup_20260305_150248', 'U') IS NOT NULL
    DROP TABLE [DW].[Dim_Wholesalers_backup_20260305_150248];
GO
...
BEGIN
    ...
    EXEC sp_rename 'DW.Dim_Wholesalers', 'Dim_Wholesalers_backup_20260305_150248';
END
GO
...
BEGIN
    ...
    FROM [DW].[Dim_Wholesalers_backup_20260305_150248];
...
CREATE UNIQUE NONCLUSTERED INDEX [UIX_NK_Dim_Wholesalers_Active] ON [DW].[Dim_Wholesalers] ([Wholesaler_Code]) WHERE [Is_Deleted] = 0;
GO