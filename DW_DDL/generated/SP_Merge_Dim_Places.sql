...
SET @UpdatedCount = 0;
        ...
        INSERT INTO [DW].[Dim_Places] (
            [Place_Code], [Place_Name], [Place_Category], [Place_Sub_Category], [Place_Chain], [Place_Address], [Place_City], [Place_Province], [Place_Country], [Place_Latitude], [Place_Longitude], [Place_Contact_Number], [Place_Contact_Name], [Place_Contact_Title], [Place_Contact_Email], [Place_Website],
            Row_Is_Current, Row_Effective_Datetime, Row_Expiry_Datetime,
            Inserted_Datetime, Updated_Datetime,
            Row_Change_Reason
        )
        SELECT 
            o.[Place_Code], o.[Place_Name], o.[Place_Category], o.[Place_Sub_Category], o.[Place_Chain], o.[Place_Address], o.[Place_City], o.[Place_Province], o.[Place_Country], o.[Place_Latitude], o.[Place_Longitude], o.[Place_Contact_Number], o.[Place_Contact_Name], o.[Place_Contact_Title], o.[Place_Contact_Email], o.[Place_Website],
            1, GETDATE(), NULL,
            GETDATE(), NULL,
            'NEW'
        FROM [ODS].[Places] o
        WHERE NOT EXISTS (
            SELECT 1 FROM [DW].[Dim_Places] d 
            WHERE d.Place_Code = o.Place_Code AND d.Row_Is_Current = 1
        );
