...
-- Generated at 2026-03-06 12:10:31

-- Drop old backup if it exists (prevents rename conflict)
IF OBJECT_ID('DW.Dim_Brands_backup_20260306_121031', 'U') IS NOT NULL
    DROP TABLE [DW].[Dim_Brands_backup_20260306_121031];
GO
...
BEGIN
    ...
    EXEC sp_rename 'DW.Dim_Brands', 'Dim_Brands_backup_20260306_121031';
END
GO
...
BEGIN
    ...
    FROM [DW].[Dim_Brands_backup_20260306_121031];
