...
IF OBJECT_ID('DW.Dim_Brands_backup_20260305_155844', 'U') IS NOT NULL
    DROP TABLE [DW].[Dim_Brands_backup_20260305_155844];
GO
...
BEGIN
    ...
    EXEC sp_rename 'DW.Dim_Brands', 'Dim_Brands_backup_20260305_155844';
END
GO
...
BEGIN
    ...
    FROM [DW].[Dim_Brands_backup_20260305_155844];
