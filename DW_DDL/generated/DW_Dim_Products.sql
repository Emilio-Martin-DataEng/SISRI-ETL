-- Safe regeneration template for DW.Dim_Products
-- Generated at 2026-03-05 09:45:40

-- Drop old backup if it exists (prevents rename conflict)
IF OBJECT_ID('DW.Dim_Products_backup_20260305_094540', 'U') IS NOT NULL
    DROP TABLE [DW].[Dim_Products_backup_20260305_094540];
GO
...
BEGIN
    ...
    EXEC sp_rename 'DW.Dim_Products', 'Dim_Products_backup_20260305_094540';
END
GO
...
BEGIN
    ...
    FROM [DW].[Dim_Products_backup_20260305_094540];
...
CREATE UNIQUE NONCLUSTERED INDEX [UIX_NK_Dim_Products_Active] ON [DW].[Dim_Products] ([Product_Code], [Product_Name], [Product_Barcode], [Principal_Code], [Brand_Code], [Product_Department], [Product_Category], [Product_Segment], [Product_Sub_Segment], [Product_Packaging_Type], [Unit_Of_Measure], [Product_Volume], [Product_Variant], [Product_Case_Size], [Product_Nappi_Code], [Product_Schedule]) WHERE [Is_Deleted] = 0;
GO