#!/usr/bin/env python3
"""
Step 3: Create Multi-Source Dynamic Procedure
"""
...
def create_multi_source_procedure():
    """Create the final multi-source dynamic procedure"""
...
"""
    ...
    return procedure_sql.format(timestamp=datetime.now().strftime('%Y-%m-%d %H:%M:%S'))

def test_step3():
    """Test Step 3: Create multi-source procedure"""
    
    print("🔧 STEP 3: Testing Multi-Source Procedure")
    print("=" * 60)
    
    try:
        # Build the procedure
        procedure_sql = create_multi_source_procedure()
        
        # Save to file
        with open('step3_multi_source_procedure.sql', 'w', encoding='utf-8') as f:
            f.write(procedure_sql)
        
        print("✅ Multi-source procedure built successfully")
        print("📄 Saved to: step3_multi_source_procedure.sql")
        print()
        
        # Show key features
        print("🎯 Key Features:")
        print("   ✅ Dynamic SELECT from metadata")
        print("   ✅ STRING_AGG for transformation building")
        print("   ✅ Handles any source in Dim_DW_Mapping_And_Transformations")
...
if __name__ == "__main__":
    ...
    success = test_step3()
    if success:
        print("🎉 STEP 3 COMPLETE: Multi-Source Procedure ready!")
        print("\n✅ Ready for STEP 4: Apply and Test")
    else:
